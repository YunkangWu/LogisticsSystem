...
<div class="rightinfo">
    ...
    <form action="${pageContext.request.contextPath}/goodsSupply/adminList">
        <table width="100%" align="center">
            ...
            <tr height="30">
                ...
                <td width="24%" align="left" valign="middle" style="height: 29px;">
                    <input name="goodsTimeStart" id="goodsTimeStart" value="${goodsTimeStart}" class="input6" onclick="WdatePicker({dateFmt:'yyyyMMdd'})">
                <td width="18%" align="right">
                    <span class="black14_2">截止日期&nbsp;</span>
                </td>
                <td width="36%" align="left">
                    <input name="goodsTimeEnd" id="goodsTimeEnd" value="${goodsTimeEnd}" class="input6" onclick="WdatePicker({dateFmt:'yyyyMMdd'})">
                </td>
            </tr>
            <tr height="35">
            ...
            <c:forEach items="${goodsSupplyList}" var="goodsSupply">
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/goodsSupply/detail?id=${goodsSupply.id}"
                        ...
                        <a href="${pageContext.request.contextPath}/goodsSupply/toChangeCheck?id=${goodsSupply.id}"
