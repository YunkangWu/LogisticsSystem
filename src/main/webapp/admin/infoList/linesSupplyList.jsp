        ...
        <table class="tablelist">
            ...
            <c:forEach items="${linesSupplyList}" var="linesSupply">
                <tr>
                    ...
                    <td>${linesSupply.lineBelong.userName}</td>
                    <td>${linesSupply.lineFrequency}</td>
                    <td>${linesSupply.lineTransportTime}</td>
                    <td><a href="${pageContext.request.contextPath}/linesSupply/detail?id=${linesSupply.id}"
                           class="tablelink">详细情况</a>
                        <a href="${pageContext.request.contextPath}/linesSupply/toChangeCheck?id=${linesSupply.id}"
