...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <li onclick="window.location.href='${pageContext.request.contextPath}/admin/addNews.jsp'"><span><img src="${pageContext.request.contextPath}/resources/images/t01.png"/></span>添加
            </li>
    ...
    <table class="tablelist">
        ...
        <c:forEach items="${newsList}" var="news">
            <tr>
                <td><input name="id" type="checkbox" value="${news.id}"/></td>
                <td>${news.id}</td>
                ...
                <td>${news.newsFrom}</td>
                <td><a href="${pageContext.request.contextPath}/news/edit?id=${news.id}" class="tablelink">修改</a> <a
                        href="${pageContext.request.contextPath}/news/delete?id=${news.id}" class="tablelink"> 删除</a></td>
            </tr>
        </c:forEach>
