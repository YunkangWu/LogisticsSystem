...
<div class="rightinfo">
    ...
    <form action="${pageContext.request.contextPath}/storagesSupply/list">
        ...
        <table class="tablelist">
            ...
            <c:forEach items="${storagesSupplyList}" var="storagesSupply">
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/storagesSupply/detail?id=${storagesSupply.id}" class="tablelink">详细情况</a>
                    </td>
                </tr>
            </c:forEach>
