...
<dl class="leftmenu">
    ...
    <dd>
        ...
        <ul class="menuson">
            <li><cite></cite><a href="${pageContext.request.contextPath}/goodsSupply/addInfo" target="rightFrame">货源</a><i></i></li>
            <li><cite></cite><a href="${pageContext.request.contextPath}/linesSupply/addInfo" target="rightFrame">专线</a><i></i></li>
            <li><cite></cite><a href="${pageContext.request.contextPath}/storagesSupply/addInfo" target="rightFrame">仓储</a><i></i></li>
            <li><cite></cite><a href="${pageContext.request.contextPath}/jobsSupply/addInfo" target="rightFrame">招聘</a><i></i></li>
        </ul>
    </dd>
