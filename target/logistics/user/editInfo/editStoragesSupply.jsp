...
<div class="formbody">
    ...
    <form action="${pageContext.request.contextPath}/storagesSupply/editStoragesSupply" method="post">
        <ul class="forminfo">
            <li><input hidden name="id" value="${requestScope.storagesSupply.id}"></li>
