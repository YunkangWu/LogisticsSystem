...
<div class="rightinfo">
    ...
    <form action="${pageContext.request.contextPath}/jobsSupply/adminList">
        ...
        <table class="tablelist">
            ...
            <c:forEach items="${jobsSupplyList}" var="jobsSupply">
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/jobsSupply/detail?id=${jobsSupply.id}"
                           class="tablelink">详细情况</a>
                        <a href="${pageContext.request.contextPath}/jobsSupply/toChangeCheck?id=${jobsSupply.id}"
